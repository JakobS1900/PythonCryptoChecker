        ...
        while True:
            ...
            if choice == '3':
                ...
                try:
                    ...
                    if amount_fiat <= 0:
                        print(f"{COLORS['red']}⚠️ Please enter a positive amount only.{COLORS['reset']}")
                        any_key()
                        continue
                    ...
                    print(f"{COLORS['red']}⚠️ Please enter a valid numeric value.{COLORS['reset']}")
                    any_key()
...
def main_session():
    ...
    while True:
        ...
        if globals()['platform_type'] == 'android':
            print(f"\n{COLORS['yellow']}📊 CRYPTO ANALYTICS PLATFORM (Top 100, {uc}){COLORS['reset']}")
        else:
            print(f"\n{COLORS['yellow']}📊 CRYPTO ANALYTICS PLATFORM (Top 100 Coins, {uc}){COLORS['reset']}")
        ...
        try:
            ...
            print(f"{COLORS['red']}⚠️ Please enter a valid number or command.{COLORS['reset']}")
            any_key()
